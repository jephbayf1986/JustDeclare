...
namespace JustDeclare
{
    public static partial class JustDeclareExtensions
    {
        ...
        public static ValidationCheck MustFallOnA(this DateTime? value, DayOfWeek target)
        {
            return new DateDayOfWeek(value, target);
        }

        public static ValidationCheck MustNotFallOnA(this DateTime? value, DayOfWeek target)
        {
